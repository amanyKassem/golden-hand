							...
							this.state.loader ?
								...
								this.props.orderDetails ?
									<View>
										...
										{/*						<Text*/}
										{/*							style={[styles.textRegular, styles.darkBrown, styles.textSize_14, styles.textLeft, {writingDirection: I18nManager.isRTL ? 'rtl' : 'ltr'}]}>{this.props.orderDetails.provider.phone}</Text>*/}
										{/*						<Text*/}
